...
local dracula_classic = {
  identifier = colors_dracula.fg,
  para = colors_dracula.pink,
  prop = colors_dracula.fg,
  var = colors_dracula.purple,
  func = colors_dracula.green,
  statement = colors_dracula.cyan,
  structure = colors_dracula.cyan,
  stringg = colors_dracula.yellow,
  comment = colors_dracula.comment,
  type = colors_dracula.orange,
  warning = colors_dracula.orange,
  err = colors_dracula.red,
}
